...
const ClothGrid = ({itemData, handleSelection, num_cols, upload}) => {
              ...
              {username &&
                <button
                  ...
                  style={{
                    ...
                    width: '32px',
                    height: '32px',
                    backgroundColor: savedImages.includes(item) ? 'red' : 'rgba(0,0,0,0.3)',
                  ...
                  onMouseEnter={e => e.currentTarget.style.backgroundColor = savedImages.includes(item) ? 'darkred' : 'rgba(0,0,0,0.6)'}
                  onMouseLeave={e => e.currentTarget.style.backgroundColor = savedImages.includes(item) ? 'red' : 'rgba(0,0,0,0.3)'}
                >
                  {savedImages.includes(item) ? <HeartFill size={16} /> : <Heart size={16} />}
                </button>
              }
            </div>
          </div>
